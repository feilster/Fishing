(function () {
  ...
  function PagesSessionsController(SessionService, VenueService, MessageService, $timeout) {
  ...
  PagesSessionsController.$inject = ['SessionService', 'VenueService', 'MessageService', '$timeout'];
