(function () {
  ...
  function PagesDashboardController(StatsService, MessageService, $timeout) {
  ...
  PagesDashboardController.$inject = ['StatsService', 'MessageService', '$timeout'];

  angular.module('fishingApp')
  .component('stats', {

    templateUrl: 'components/stats/stats.html',
    controller: PagesDashboardController
